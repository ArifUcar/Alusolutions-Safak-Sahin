    ...
    <div className="legal-page">
      ...
      <section className="legal-content">
        <div className="container">
          ...
          <p>In deze voorwaarden wordt verstaan onder AluSolutions: de onderneming gevestigd te Reuver, ingeschreven bij de KVK onder nummer 90086449.</p>

          <h2>Artikel 2 - Toepasselijkheid</h2>
          <p>Deze voorwaarden zijn van toepassing op alle aanbiedingen en overeenkomsten van AluSolutions.</p>
          ...
          <p>AluSolutions biedt 10 jaar garantie op de constructie bij normaal gebruik.</p>
