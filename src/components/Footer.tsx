    ...
    <footer className="main-footer">
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-links">
            ...
            <ul>
              ...
              <li><Link to="/blog">{t('header.blogsTips')}</Link></li>
              <li><Link to="/showroom">{t('header.visitShowroom')}</Link></li>
              <li><Link to="/faq">FAQ</Link></li>
            </ul>
          </div>

          <div className="footer-links">
            <h4>{t('header.requestQuote')}</h4>
            <ul>
        ...
        <div className="footer-bottom">
          <p>&copy; 2025 VivaVerandas. {t('header.tagline')}</p>
          <p className="footer-subsidiary">
            {t('footer.subsidiary', { defaultValue: 'Een onderdeel van' })}{' '}
            <a href="https://www.alusolutions.nl/" target="_blank" rel="noopener noreferrer">
              AluSolutions.nl
            </a>
          </p>
